...
## Environments
- Preview: https://main--bmw-fr--aemysites.aem.page/
- Live: https://main--bmw-fr--aemysites.aem.live/
- Block Library: https://main--bmw-fr--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `bmw-fr` directory in your favorite IDE and start coding :)
